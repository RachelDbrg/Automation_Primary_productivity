...
setwd("~/Automation_Primary_productivity/scripts/One_more_prey_decrease_lichen_PP")
...
my_function <- function(simulation_index, ...){
  ...
  saveRDS(res, file = "~/Automation_Primary_productivity/scripts/One_more_prey_decrease_lichen_PP/Results/sim1.R")
